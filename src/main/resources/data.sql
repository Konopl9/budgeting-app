...
values
    ...
    (nextval('transaction_id_seq'), 'TSLA', 'BUY', '2024-02-23', 80, 800.25, -64020, 12, 'My portfolio'),
    (nextval('transaction_id_seq'), 'AAPL', 'BUY', '2024-02-24', 90, 150.25, -13522.5, 9, 'My portfolio'),
    (nextval('transaction_id_seq'), 'AMZN', 'BUY', '2024-02-25', 60, 3300.75, -198045, 20, 'My portfolio'),
    (nextval('transaction_id_seq'), 'GOOGL', 'BUY', '2024-02-26', 110, 2900, -319000, 14, 'My portfolio'),
    (nextval('transaction_id_seq'), 'MSFT', 'BUY', '2024-02-27', 70, 330.50, -23135, 10, 'My portfolio'),
    ...
    (nextval('transaction_id_seq'), 'AMZN', 'BUY', '2024-03-01', 95, 3300.75, -313527.25, 18, 'My portfolio'),
    ...
    (nextval('transaction_id_seq'), 'TSLA', 'BUY', '2024-03-04', 75, 800.25, -60018.75, 10, 'My portfolio'),
    (nextval('transaction_id_seq'), 'AAPL', 'SELL', '2024-03-05', 30, 160.25, 4807.5, 8, 'My portfolio'),
    (nextval('transaction_id_seq'), 'AMZN', 'SELL', '2024-03-06', 40, 3350.75, 134030, 15, 'My portfolio'),
    (nextval('transaction_id_seq'), 'GOOGL', 'SELL', '2024-03-07', 50, 2950, 147500, 10, 'My portfolio');
